...
<nav class="flex w-full items-center justify-end bg-gray-800 py-8 px-12 sticky top-0 z-40 ">
    <div class="flex space-x-7">
      ...
      <a href="/favorites" class="text-gray-300 text-sm hover:text-white block relative  leading-3 " >FAVORITES
        <div class="w-[1rem] bg-gray-900 -top-4 -right-5 h-[1rem] absolute flex justify-center items-center p-3 text-sm font-bold text-red-100 rounded-[50%]">
          {#key noOfFavorites}
